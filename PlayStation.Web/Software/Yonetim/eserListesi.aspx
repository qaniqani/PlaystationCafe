<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Admin.master" AutoEventWireup="true" CodeFile="eserListesi.aspx.cs" Inherits="Yonetim_eserListesi" %>
                ...
                <asp:Repeater ID="Repeatericerik" runat="server" 
                    ...
                    <ItemTemplate>
                        <tr class="gradeX">
                            ...
                            <td class="c">
                                <a href="eserEkle.aspx?id=<%#Eval("ICERIKID") %>"><img style="position:relative;top:7px" src='css/images/icons/light/create_write.png' border='0' width='25'/></a>
                            </td>
                            <td class="c">
