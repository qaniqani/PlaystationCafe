...
public partial class Yonetim_AlbumResimEkle2 : System.Web.UI.Page
{
    ...
    private void AlbumResimGetir()
    {
        try
        {
            ...
            var aResim = db.ALBUMRESIMs.Where(a => a.ALBUMID == 2).OrderBy(a => a.RESSIRA);
