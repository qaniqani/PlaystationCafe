...
public partial class Yonetim_OrganizasyonListesi : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lt.Text = "Organizasyon Listesi";
            HyperLink hpyeni = Master.FindControl("hpyeni") as HyperLink;
            hpyeni.Visible = true;
            hpyeni.Text = "Yeni Organizasyon";
            hpyeni.NavigateUrl = "organizasyonekle.aspx";
            IcerikGetir();
        }
    ...
    private void IcerikGetir()
    {
        ...
        var icerikler = from i in db.ICERIKs where i.ICERIKDIL == 1 && i.ICERIKKATID ==5 orderby (i.ICERIKSIRA) select i;
