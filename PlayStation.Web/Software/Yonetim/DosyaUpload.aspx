<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Admin.master" AutoEventWireup="true" CodeFile="DosyaUpload.aspx.cs" Inherits="Yonetim_DosyaUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div class="g12" id="divicerik" runat="server">
   <div id="divhata" runat="server" visible="false" class="alert warning">
    ...
    <div class="g12"><h3>Dosyalar</h3></div>
    <div class="g12">
                ...
                <asp:Repeater ID="RepeaterUrun" runat="server" OnItemCommand="RepeaterUrun_ItemCommand">
                    <ItemTemplate>
                        <tr class='gradeX'>
                            ...
                            <td valign="middle">
                           <a href='<%#Eval("DOSYAYOLU")%>' target="_blank">   <%#Eval("DOSYAYOLU")%></a> 
                            </td>
