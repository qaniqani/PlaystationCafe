...
public partial class Yonetim_BrosurEkle : System.Web.UI.Page
{
    ...
    private void DosyaGetir()
    {
        ...
        var dosyalar = db.DOSYAUPLOADs.Where(d => d.DIL == dil && d.DOSYATUR == 2).ToList();
    ...
    protected void RepeaterUrun_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Sil")
        {
            ...
            try
            {
                File.Delete(MapPath("../images/Dosya/" + du.DOSYAYOLU));
            }
            catch
            {
