...
public partial class Yonetim_eserListesi : System.Web.UI.Page
{    YonetimEntities db = new YonetimEntities();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lt.Text = "Eser Listesi";
            HyperLink hpyeni = Master.FindControl("hpyeni") as HyperLink;
            hpyeni.Visible = true;
            hpyeni.Text = "Yeni Eser";
            hpyeni.NavigateUrl = "eserEkle.aspx";
            IcerikGetir();
        }
    ...
    private void IcerikGetir()
    {
        ...
        var icerikler = from i in db.ICERIKs where i.ICERIKDIL == 1 && i.ICERIKKATID==3 orderby (i.ICERIKSIRA) select i;
