<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Admin.master" AutoEventWireup="true" CodeFile="AlbumResimEkle2.aspx.cs" Inherits="Yonetim_AlbumResimEkle2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="g12" id="divicerik" runat="server">
        ...
        <table class="padding">
            ...
            <tr id="trbelge" runat="server" visible="false">
                <td width="200">
                    Ana Logo
                </td>
                <td width="10">
