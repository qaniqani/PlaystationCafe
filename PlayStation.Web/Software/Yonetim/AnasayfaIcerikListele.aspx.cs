...
public partial class Yonetim_AnasayfaIcerikListele : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lt.Text = "Anasayfa İçerik Listesi";
    ...
    private void IcerikGetir()
    {
        ...
        var icerikler = from i in db.ICERIKs where i.ICERIKDIL == 1 && i.ICERIKKATID == 1  orderby (i.ICERIKSIRA) select i;
