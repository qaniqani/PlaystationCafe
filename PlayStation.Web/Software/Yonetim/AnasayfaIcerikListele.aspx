<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Admin.master" AutoEventWireup="true" CodeFile="AnasayfaIcerikListele.aspx.cs" Inherits="Yonetim_AnasayfaIcerikListele" %>
                ...
                <asp:Repeater ID="Repeatericerik" runat="server" 
                    ...
                    <ItemTemplate>
                        <tr class="gradeX">
                            ...
                            <td class="c">
                                <a href="AnasayfaIcerikEkle.aspx?id=<%#Eval("ICERIKID") %>"><img style="position:relative;top:7px" src='css/images/icons/light/create_write.png' border='0' width='25'/></a>
                            </td>
                            <td class="c">
