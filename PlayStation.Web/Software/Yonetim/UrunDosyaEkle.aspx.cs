...
public partial class Yonetim_UrunDosyaEkle : System.Web.UI.Page
{
    ...
    private void DosyaGetir()
    {
        ...
        var urundosya = from d in db.URUNDOSYAs where d.URID == urunid && d.TIP == 1 select d;
