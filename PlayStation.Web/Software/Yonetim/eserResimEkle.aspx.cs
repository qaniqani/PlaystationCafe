...
public partial class Yonetim_eserResimEkle : System.Web.UI.Page
{
    ...
    private void IcerikGetir()
    {
        ...
        var icerikler = (from d in db.ICERIKs where d.ICERIKDIL == dil && d.ICERIKKATID==3 select d).OrderBy(s => s.ICERIKSIRA);
        drpUrun.Items.Clear();
