...
public partial class Yonetim_menuListesi : System.Web.UI.Page
{
    ...
    private void IcerikGetir()
    {
        ...
        var icerikler = from i in db.ICERIKs where i.ICERIKDIL == 1 && i.ICERIKKATID ==4 orderby (i.ICERIKSIRA) select i;
