<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Admin.master" AutoEventWireup="true" CodeFile="menuEkle.aspx.cs" Inherits="Yonetim_menuEkle" %>
    ...
    <div class="g12" id="divicerik" runat="server" visible="false">
        ...
        <table id="TblIcerik" runat="server" class="padding">
            ...
            <tr>
             ...
             <tr id="trres" runat="server" visible="true">
                <td width="150">
                </td>
                <td width="10">
                </td>
