<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Admin.master" AutoEventWireup="true" CodeFile="BizKimizAltIcerikEkle.aspx.cs" Inherits="Yonetim_BizKimizAltIcerikEkle" %>
    ...
    <div class="g12" id="divicerik" runat="server" visible="false">
        ...
        <table id="TblIcerik" runat="server" class="padding">
            ...
            <tr id="Tr1" runat="server" visible="false"> 
                ...
                <td width="600">
                    <asp:FileUpload runat="server" ID="ltranasayfaicerikresimekle" />
                    <asp:HiddenField runat="server" ID="hfgizlii" />
                </td>
            </tr>
            <tr>
                <td width="200">
                ...
                <td width="300">
                    <asp:FileUpload ID="FileUploadImg" runat="server" />
                        ...
                        <tr id="trdosya" runat="server" visible="true" clientidmode="Static">
                <td width="200">
                    Dosya
                </td>
                <td width="10">
