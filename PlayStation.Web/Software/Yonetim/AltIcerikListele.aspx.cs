...
public partial class Yonetim_AltIcerikListele : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lt.Text = "Biz Kimiz Alt Içerik Listesi";
            HyperLink hpyeni = Master.FindControl("hpyeni") as HyperLink;
            hpyeni.Visible = true;
            hpyeni.Text = "Yeni İçerik";
            hpyeni.NavigateUrl = "BizKimizAltIcerikEkle.aspx";
            IcerikGetir();
        }
    ...
    private void IcerikGetir()
    {
        ...
        var icerikler = from i in db.ICERIKs where i.ICERIKDIL == 1 && i.ICERIKKATID == 33 orderby (i.ICERIKSIRA) select i;
