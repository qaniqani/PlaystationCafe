<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Admin.master" AutoEventWireup="true" CodeFile="IndirEkle.aspx.cs" Inherits="Yonetim_IndirEkle" %>
...
<div class="g12" id="divicerik" runat="server">
   <div id="divhata" runat="server" visible="false" class="alert warning">
    ...
    <div class="g12"><h3>Broşürler</h3></div>
    <div class="g12">
                ...
                <asp:Repeater ID="RepeaterUrun" runat="server" OnItemCommand="RepeaterUrun_ItemCommand">
                    <ItemTemplate>
                        <tr class='gradeX'>
                            ...
                            <td valign="middle">
                           <a href='<%#"/images/Dosya/"+Eval("DOSYAYOLU")%>' target="_blank">   <%#"/images/Dosya/"+Eval("DOSYAYOLU")%></a> 
                            </td>
                         
                            <td valign="middle">
                                <asp:LinkButton ID="BtnSil" style="position:relative;top:9px" OnClientClick=" return confirm('Silmek istediğinize eminmisiniz ?')"
                                    runat="server" Text="<img src='css/images/icons/light/cross.png' border='0' width='30'/>"  CommandArgument='<%#Eval("DOSYAID")%>'
                                    CommandName="Sil" />
                            </td>
                        </tr>
                    </ItemTemplate>
